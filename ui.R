...
dashboardHeader(title = "HR Analytics"),
  ...
  dashboardBody(
    ...
    setBackgroundImage(
      src = "https://wallpaperaccess.com/full/2053097.png",shinydashboard = TRUE
    ),
...
h2(strong("Human Resource Analytics",style = "color:white")),
        
  p(h3("Human Resource management is one of the key function of an organization.",style = "color:white")),
  p(h3("Human Resource management acts like a fuel to the gears of an organization.",style = "color:white")),
  
  p(h3("Every organisation strives for acquring, developing, motivating and",style = "color:white")),
  p(h3("retaining human resource to ensure smooth working to achieve organizational objectives",style = "color:white")),

p(h3("The HR is the one responsible to make decision in every step of functionality",style = "color:white")),

p(h3("The role of a HR includes:",style = "color:white")),
p(h3("1) Planning for staffing need",style = "color:white")),
p(h3("2) Employee Recruitment and Selection",style = "color:white")),
p(h3("3) Employee training and Performance evaluation",style = "color:white")),
p(h3("4) Employee compensation and benifits",style = "color:white")),
p(h3("5) Employee relation, motivation and engagement",style = "color:white")),

p(h3("One of the way to encourage employees is through promotion to handle new roles and responsibilities.",style = "color:white")),
p(h3("In an organisation of many employees decision of promotion is a difficult task!",style = "color:white")),
p(strong(h3("Not to worry!",style = "color:white", align= "center"))),
p(strong(h3("Here is an application developed by team Horcrux to help an HR select the elligible candidates to next job level.",style = "color:white"))),
...
h3(strong("Methodology used",style = "color:white")),
p(h3("We have used random forest method in deciding the promotion of an employee. 
     Entering the required details will give an output ",style = "color:white"))
...
#-------------------------------------------------------------------------------------------------------------------------------#              
      tabItem(tabName = "pred",
        ...
        h2(strong("Please Enter Correct details",style = "color:white")),
